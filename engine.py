"""
Mastery Engine — Roognis AI

Updates per-concept mastery scores (0–100) after each student interaction.
Uses an EMA-style smoothed gain model keyed on Bloom's taxonomy level.
Higher Bloom levels yield more gain; misconceptions apply a 15-point penalty.
"""
from uuid import UUID

import structlog

from domain import AbstractConceptNodeRepository, AbstractMasteryRepository, ConceptExtractionResult
...
class MasteryEngine:
    ...
    async def update_from_extraction(
        ...
        for concept_name in all_concepts:
            ...
            logger.debug("mastery_updated", user_id=str(user_id), concept=concept_name,
