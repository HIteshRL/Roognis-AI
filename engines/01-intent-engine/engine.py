"""
Intent Engine — Phase 0.5 (Roognis AI)

Classifies each student message into a pedagogical intent category using
rule-based pattern matching. Synchronous and zero-latency. No I/O, no
external dependencies — drop this file anywhere and import IntentEngine.
